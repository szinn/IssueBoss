...
async fn artifact_lifecycle() {
    ...
    let issue = ctx
        .services
        .issue_service()
        .transition_issue(issue.token, IssueStatus::TriageReview, Some("Triage done".into()), Some(0))
        .await
        .unwrap();
    ...
    let issue = ctx
        .services
        .issue_service()
        .transition_issue(issue.token, IssueStatus::ResearchNeeded, None, Some(0))
        .await
        .unwrap();
    ...
    let issue = ctx
        .services
        .issue_service()
        .transition_issue(issue.token, IssueStatus::ResearchInProgress, None, Some(0))
        .await
        .unwrap();
    ...
    let err = ctx
        .services
        .issue_service()
        .transition_issue(issue.token, IssueStatus::ResearchReview, None, Some(0))
        .await;
